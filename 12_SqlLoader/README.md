...
Voraussetzung für diesen Schritt ist, dass *C:\Temp* in der virtuellen Maschine (Oracle 12) bzw.
*C:\Temp\oracle-home* im Docker Container (Oracle 21) sichtbar ist.
...
export DOTNET_SYSTEM_GLOBALIZATION_INVARIANT=1
cd
/media/sf_Temp/oracle-home/DataGeneratorBuild/DataGenerator 10000
```
